...
| argilla-server | [`argilla-status-exposed`](templates/exposure/argilla-status-exposed.yaml) | low |
...
| h2o-3 | [`h2o-cluster-status-exposed`](templates/exposure/h2o-cluster-status-exposed.yaml) | high |
...
| infinity-db | [`infinity-db-databases-exposed`](templates/exposure/infinity-db-databases-exposed.yaml) | high |
...
| steel-browser | [`steel-browser-sessions-exposed`](templates/exposure/steel-browser-sessions-exposed.yaml) | high |
